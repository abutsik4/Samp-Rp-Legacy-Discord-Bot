...
function buildFactionGuide(cat: LiveCategory, color: string, structure: LiveStructure): GuideEmbed {
  ...
  for (const ch of textChannels) {
    ...
    else if (n.includes("оператив")) desc = "Канал для оперативных сообщений и координации смен.\nИспользуйте для информирования о текущих операциях.";
    else if (n.includes("департамент")) desc = "Канал департамента для внутренней координации.\nОбсуждения смен, задач и рабочих вопросов.";
    else if (n.includes("казарм")) desc = "Канал казармы для координации военных.\nБоевые задачи, дежурства, внутренние вопросы.";
    else if (n.includes("ординаторск")) desc = "Канал ординаторской для медицинского персонала.\nКоординация смен, пациенты, рабочие вопросы.";
    else if (n.includes("учебный") || n.includes("учебн")) desc = "Учебный центр для координации обучения.\nРасписание занятий, экзаменов и инструктажей.";
    else if (n.includes("канцеляр")) desc = "Канцелярия для юридических вопросов.\nДела, заседания, документооборот.";
    else if (n.includes("обсужден")) desc = "Канал для обсуждений между участниками.\nДелитесь идеями, планами и предложениями.";
    else if (n.includes("управлен") && n.includes("рол")) desc = "Управление составом организации.\nСнятие ролей через интерактивное меню.";
  ...
  for (const ch of voiceChannels) {
    ...
    else if (n.includes("брифинг") || n.includes("briefing")) desc = "Голосовой канал для инструктажа и координации.\nСбор перед операциями и сменами.";
    else if (n.includes("оперштаб") || n.includes("штаб")) desc = "Оперативный голосовой канал для быстрой координации.\nИспользуйте для срочных ситуаций.";
    else if (n.includes("патрул")) desc = "Голосовой канал для патрульных.\nКоординация во время патрулирования.";
    else if (n.includes("дежурств")) desc = "Голосовой канал для дежурных.\nСвязь во время дежурной смены.";
    else if (n.includes("экзамен")) desc = "Голосовой канал для проведения экзаменов.\nИспользуйте для устных проверок и тестирования.";
    else if (n.includes("заседан")) desc = "Голосовой канал для проведения судебных заседаний.\nОфициальные слушания и разбирательства.";
    else if (n.includes("кабинет")) desc = "Голосовой канал — кабинет.\nДля приватных переговоров и консультаций.";
    else if (n.includes("1") && (n.includes("x") || n.includes("×") || n.includes("на"))) desc = "Голосовой канал на 2 участника (лимит: 2).\nДля приватных голосовых разговоров.";
    else if (n.includes("2") && (n.includes("x") || n.includes("×") || n.includes("на"))) desc = "Голосовой канал для малых групп (лимит: 4).\nНапример, совместное патрулирование или операция.";
